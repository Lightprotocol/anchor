...
// Compressed mint runtime helpers (no-op by default)
#[cfg(feature = "compressed-mint")]
pub mod compressed_mint;
#[cfg(feature = "compressed-mint")]
pub use compressed_mint::CompressedBatchContext;
...
// Provide a blanket impl so all account field types satisfy AccountsFinalize by default.
// Removed blanket impl to avoid conflicting impls for Accounts structs generated by derive.
...
pub mod prelude {
    #[cfg(feature = "compressed-mint")]
    pub use super::accounts::cmint::CMint;
    pub use super::{
        ...
        AccountsClose, AccountsExit, AccountsFinalize, AnchorDeserialize, AnchorSerialize,
        Discriminator, Id, InitSpace, Key, Lamports, Owner, ProgramData, Result, Space,
